...
using AngryNinjas.Shared.Layers;
...
namespace AngryNinjas.Shared.Levels
{
    public class TheLevel : CCLayer
    {
        ...
        protected override void AddedToScene()
        {
            ...
            layerInstance = this;
            //get screen size
            screenSize = CCDirector.SharedDirector.WinSizeInPixels; //CCDirector::sharedDirector()->getWinSize();
        ...
        {
            CCLog.Log("Show Menu");
            CCDirector.SharedDirector.PushScene(TheMenu.GetScene());
        }
        ...
        void SetUpParticleSystemSun()
        {
            ...
            system = new CCParticleSun((int)new CCPoint(240, 400).Length);
        ...
        public override void TouchesBegan(List<CCTouch> touches)
        {
            foreach (var touch in touches)
            {
                ...
                location.Y = CCDirector.SharedDirector.WinSizeInPixels.Height - location.Y;
        ...
        {
            get { return new CCTransitionFadeDown(1, TheLevel.GetScene()); }
        }

        CCTransitionScene Transition1
        {
            get { return new CCTransitionFlipX(1, TheLevel.GetScene(), CCTransitionOrientation.RightOver); }
        }

        CCTransitionScene Transition2
        {
            get { return new CCTransitionFade(1, TheLevel.GetScene()); }
        }

        CCTransitionScene Transition3
        {
            get { return new CCTransitionFlipAngular(1, TheLevel.GetScene(), CCTransitionOrientation.DownOver); }
        }

        CCTransitionScene Transition4
        {
            get { return new CCTransitionFadeTR(1, TheLevel.GetScene()); }
        }
