    ...
    public class IntroLayer : CCLayerColor
    {
        ...
        public override void TouchesBegan(List<CCTouch> touches)
        {
            ...
            if (touch != null)
            {
                ...
                else
                {
                    ...
                    CCPoint tap = touch.LocationInView; ; ; //??��?�?
                    tap.Y = CCDirector.SharedDirector.WinSizeInPixels.Height - tap.Y;
        ...
        private void createActions()
        {
            ...
            CCFiniteTimeAction easeSwing = new CCSequence(
                           ...
                           new CCEaseInOut(new CCRotateTo(1.2f, 10), 2));
            _swingHealth = new CCRepeatForever(new CCActionEase(easeSwing));
            //_swingHealth ->retain();
            ...
            for (i = 1; i <= 10; i++)
            {
                ...
                frame = spriteFrameCache.SpriteFrameByName(string.Format("boom{0}.png", i));
            ...
            for (i = 1; i <= 7; i++)
            {
                ...
                frame = spriteFrameCache.SpriteFrameByName(string.Format("explosion_small{0}.png", i));
        ...
        private void createGameScreen()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                cloud = new CCSprite(CCSpriteFrameCache.SharedSpriteFrameCache.SpriteFrameByName("cloud.png")); // new CCSprite("cloud.png");
                ProcessSprite(cloud);
