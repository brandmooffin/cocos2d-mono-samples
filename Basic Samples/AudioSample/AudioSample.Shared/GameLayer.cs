...
using System.Text;
using AudioSample.Windows;
using Cocos2D;
using CocosDenshion;

namespace AudioSample.Shared
{
    public class GameLayer : CCLayerColor
    {
        ...
        class Button : CCNode
        {
            ...
            public Button(CCSprite sprite): this()
            {
                child = sprite;
                AddChild(sprite);
            }
            ...
            {
                child = new CCLabel(text, "arial", 16);
                AddChild(child);
            ...
            bool touchHits(CCTouch touch)
            {
                ...
                var area = child.WorldBoundingBox;
                return area.ContainsPoint(location);
            }
        ...
        class AudioSlider : CCNode
        {
            ...
            public void SetValue(float minValue, float maxValue, float value)
            {
                ...
                if (lblMinValue == null)
                {
                    lblMinValue = new CCLabel(valueText, "arial", 10) { AnchorPoint = CCPoint.AnchorMiddleLeft };
                ...
                if (lblMaxValue == null)
                {
                    lblMaxValue = new CCLabel(valueText, "arial", 10) { AnchorPoint = CCPoint.AnchorMiddleRight };
        ...
        void AddButtons()
        {
            ...
            var lblMusic = new CCLabel("Control Music", "Arial", 48);
            ...
            var lblSound = new CCLabel("Control Effects", "arial", 48);
        ...
        void AddSliders()
        {
            ...
            var lblEffectsVolume = new CCLabel("Effects Volume", "arial", 16);
            ...
            var lblMusicVolume = new CCLabel("Music Volume", "arial", 16);
        ...
        void AddSoundSelections()
        {
            ...
            var lblEffectFiles = new CCLabel("Current Effect", "arial", 14);
            ...
            var lblBackgroundFiles = new CCLabel("Current Background", "arial", 14);
        ...
        {
            var size = WorldBoundingBox.Size;
